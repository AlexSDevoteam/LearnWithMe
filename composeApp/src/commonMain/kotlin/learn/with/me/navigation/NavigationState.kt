    ...
    val serializersConfig = SavedStateConfiguration {
        serializersModule = SerializersModule {
            polymorphic(NavKey::class) {
                subclass(LessonRoute.Lesson.List::class, LessonRoute.Lesson.List.serializer())
                subclass(LessonRoute.Lesson.Favorites::class, LessonRoute.Lesson.Favorites.serializer())
                subclass(SettingsRoute.Settings::class, SettingsRoute.Settings.serializer())
            }
        }
    }
